...
export default function CartPaymentMethods({ className, isBlockHidden }: CartPaymentMethodsProps) {
  ...
  const halfOpacityOnHidden = isBlockHidden ? 'opacity-50' : '';
  ...
  return (
    <div className={`mt-3 flex flex-col gap-2 p-4 ${className}`}>
      ...
      <div className="flex items-center gap-2">
        <RiVisaLine size="2.6rem" color="#254AA5" className={halfOpacityOnHidden} />
        <IconMasterCard className={halfOpacityOnHidden} />
        <FaApplePay size="2.6rem" className={halfOpacityOnHidden} />
