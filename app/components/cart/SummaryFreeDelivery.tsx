...
export default function SummaryFreeDelivery() {
  ...
  return (
    <>
      <span className={`text-nowrap text-[15px] ${albert_500.className}`}>{freeDeliveryText}</span>
      <span className={`justify-self-end text-[15px] ${albert_500.className}`}>{amountUntilFreeDelivery}</span>
