...
export default function FilterTitle({
  ...
  return (
    <div className="">
      ...
      <h3
        className={`flex cursor-pointer select-none justify-between gap-4 text-[13px] sm:text-[19px] xl:text-[0.875rem] whitespace-nowrap sm:w-full xl:w-[300px] ${albert_700.className}`}
