...
export default function FilterItem({ children, objectKey }: FilterItemProps) {
  ...
  return (
    <div className={`border-bkg flex w-min items-baseline gap-4 whitespace-nowrap text-[16px] ${albert_500.className} ${borderRadius} mt-2 border-[0.1rem] bg-t_mustard px-5 py-2`}>
      <span>{children}</span>
