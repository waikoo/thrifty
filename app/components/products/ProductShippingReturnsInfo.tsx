...
export default function ProductShippingReturnsInfo() {
  ...
  return (
    <div className="pt-8">
      ...
      <div className="bg-faded text-bkg mt-5 h-[7.8rem] p-5">
        {info === 'shipping' ? (
        ...
        <span className="font-regular block cursor-pointer text-right text-[0.6875rem] underline underline-offset-4">More Info</span>
      </div>
