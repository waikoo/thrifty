...
export default function HelpReturns() {
  ...
  return (
    <div className="text-left">
      ...
      <p className={`${albert_600.className} text-[13px] sm:text-[17px] xl:text-[14px]`}>We want you to be completely satisfied with your purchase. If you are not happy with your items for any reason, you can return them within 30 days of receipt for a full refund, provided they are in their original condition.</p>

      <span className={`${albert_800.className} text-[13px] sm:text-[17px] xl:text-[15px] block`}>HOW TO RETURN AN ITEM</span>
      ...
      <p className={`${albert_600.className} text-[13px] sm:text-[17px] xl:text-[14px]`}>For further assistance,"+please contact our Customer Service team at <a href="mailto:thriftstudio@shop.com">thriftstudio@shop.com</a> or call <a href="tel:1234567890">1234567890</a>. We are here to help you with any questions or concerns you may have."</p>

      <p className={`${albert_600.className} text-[13px] sm:text-[17px] xl:text-[14px]`}>Thank you for shopping with us!</p>
    </div>
  )
}
