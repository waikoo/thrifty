...
const SignInOrUp = () => {
  ...
  return (
    <dialog className="fixed inset-0 z-40 grid sm:h-screen w-full sm:place-items-center bg-black bg-opacity-50"
      ...
      ref={dialogRef}
    >
      <section className="h-screen sm:h-auto sm:w-[500px] xl:w-auto bg-t_white dark:bg-t_dark relative flex flex-col gap-2 pt-10 pb-6 rounded-0 sm:rounded-[2.1875rem] border-[0.625rem] border-t_mustard text-[0.8125rem] sm:text-[1.0625rem] xl:*:text-[0.875rem] z-[60]">
