...
export default function RecoverPasswordConfirmation() {
  ...
  return (
    ...
    >
      ...
      <span className={`${albert_900.className} text-[1.0625rem] sm:text-[1.3125rem] xl:text-[1.125rem] text-center tracking-wide mt-8`}>PASSWORD RESET EMAIL SENT</span>
      <p className={`${albert.className} text-[0.8125rem] tracking-wide max-w-[200px] text-center mx-auto mt-10 xl:text-[17px]`}>Instructions for resetting your password have been sent to <span className={`${albert_600.className}`}>{email}</span>.</p>
