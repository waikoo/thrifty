...
export default function HamburgerMenu() {
  ...
  return showHamburgerMenu && <Portal>
    <section className="fixed inset-0 z-[100] h-screen w-screen bg-[rgba(0,0,0,0.5)]"
      ref={bgRef}
      onClick={handleCloseHamburgerMenu}
      data-testid="hamburger-menu"
    >
      <div className="w-[80%] sm:max-w-[26.0625rem] text-t_black dark:text-t_black h-[calc(100dvh)] overflow-y-auto">
