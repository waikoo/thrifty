...
export default function CheckoutContact({ type, text, id }: CheckoutContactProps) {
  const { firstName, setFirstName, lastName, setLastName, phone, setPhone, email, setEmail, address, setAddress, city, setCity, country, setCountry, zipcode, setZipcode } = useCheckoutStore()
  ...
  return (
    <div className="relative flex w-full flex-col">
      <input className="bg-bkg border-b-content peer border-x-0 border-b-[0.1rem] border-t-0 border-solid pl-0 placeholder-transparent focus:ring-0" id={id} type={type} placeholder={text} value={values[id]} onChange={handleOnChange} />
