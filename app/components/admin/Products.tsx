...
export default function Products({ params }: ProductsProps) {
  ...
  return (
    <div className={`hover:text-t_admin_black hover:bg-white text-[#e3e3e3] rounded-[5px] flex whitespace-nowrap self-baseline items-baseline gap-2 cursor-pointer px-2`}
