...
export default function ProductState({ uuidMatch }: ProductStateProps) {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <ProductSelect obj={top.find((item) => item.name === 'GENDER')!} value={uuidMatch[0].gender} />
      <ProductSelect obj={top.find((item) => item.name === 'CATEGORY')!} value={uuidMatch[0].category} />
      <ProductSelect obj={top.find((item) => item.name === 'PRODUCT TYPE')!} value={uuidMatch[0].type} />

      <ProductInput icon="€" name="price" placeholder="Ex: 25" value={uuidMatch[0].price.toString()} />
      <ProductInput icon="%" name="discount" placeholder="Ex: 50" value={uuidMatch[0].discount.toString()} />
      <ProductInput icon="" name="size" placeholder="Ex: M" value={uuidMatch[0].size} />

      <ProductSelect obj={bottom.find((item) => item.name === 'COLOR')!} value={uuidMatch[0].color} />
      ...
      <ProductSelect obj={bottom.find((item) => item.name === 'CONDITION')!} value={uuidMatch[0].condition} />
