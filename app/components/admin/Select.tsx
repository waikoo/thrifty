...
export default function Select({ name, content, value, defaultSelect = '- Select -' }: SelectProps) {
  ...
  return (
    <select
      name={lowerCaseName}
      id={lowerCaseName}
      className={tm("border-[1px] border-[#1b1b1b] focus:ring-yellow text-[#e6e6e6] bg-[#151515] relative w-full appearance-none p-2 pr-[10.3rem] text-[0.8125rem] font-normal focus:outline-none focus:ring-[0.15rem]")}
