...
export default function LayoutAddNew({ params }: LayoutAddNewParams) {
  ...
  return (
    <div
      ...
      className="hover:text-t_admin_black hover:bg-white text-[#e3e3e3] rounded-[5px] flex w-21 cursor-pointer items-baseline justify-start gap-2 self-baseline px-2"
    >
