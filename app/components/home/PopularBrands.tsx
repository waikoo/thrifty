...
export default function PopularBrands() {
  ...
  return (
    <section className={`${textColor} bg-t_mustard w-full max-w-full relative mt-5`}>
      ...
      <span className="text-[15.5vw] lg:text-[8.5vw] lg:ml-[4rem] lg:tracking-[5rem] font-alokary block text-center">
        BRANDS
      </span>
      <div className={`absolute bottom-0 left-0 right-0 z-10 ${bgColor} h-[4vw] sm:h-[3.2vw] lg:h-[1.7vw] -mb-2`}></div>
    </section>
  )
}
