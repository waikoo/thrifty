...
export default function HeroImage({ gender, state }: HeroImageProps) {
  ...
  const height = state === 'new_in' ? 'xl:h-[39rem] 2xl:h-[48rem] 3xl:h-[55rem]' : 'xl:h-[39.375]'

  return (
    <div className={`w-full flex ${salePadding} ${blackOnSale} ${borderRadius} h-[27.3125rem] sm:h-[43rem] md:h-[60rem] xl:h-[39.375rem] 2xl:h-[48.2rem] 3xl:h-[55.2rem] rounded-[1.8rem] relative border-[0.125rem] ${borderColor}`}>
      {state === 'new_in' &&
