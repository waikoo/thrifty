...
export default function HeroTextNewIn() {
  ...
  return (
    <div className="z-[200] font-alokary text-[40px] leading-none text-white text-shadow shadow-black tracking-widest flex items-center h-full justify-end bg-red-200">
