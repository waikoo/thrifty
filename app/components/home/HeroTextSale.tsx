  ...
  return (
    <div className="absolute top-[7rem] left-0 right-0 sm:top-[8rem] md:top-[6rem] lg:-right-[40rem] xl:-right-[53rem] lg:top-[9rem]">
      <div className="relative text-center">
        ...
        <span className="text-[6.875rem] left-0 right-0 mx-auto text-transparent text-center font-avant_garde text-shadow-nm shadow-t_green sm:text-[18.75rem] lg:text-[11.25rem] absolute"> 80 </span>
