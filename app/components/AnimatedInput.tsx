...
export default function AnimatedInput({ type, id, placeholder, value, onChange, className, font }: AnimatedInputProps) {
  ...
  return (
    <div className="relative">
      <input
        className={tm(`${className} bg-bkg text-grey border-b-grey border-grey peer w-full border-x-0 border-b-[0.1rem] border-t-0 border-solid pl-0 placeholder-transparent focus:border-sky-500 focus:outline-none focus:ring-0`)}
        id={id}
        type={type}
